          ...
          <ScrollView style={{flex: 1, marginBottom: heightDimension * 0.05}}>
            {dataCustomer.length > 0 ? (
              dataCustomer.map((customer, index) => (
                <Animated.View
                           entering={FadeInLeft.duration(500 + (index * 100))}
          ...
          <BottomSheetModal
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                setinputInstagramNewDownLineFixing(dataCustomerMore.instagram);
              ...
              <View
                ...
                <View
                  ...
                  <FontAwesome name="edit" size={20} color="rgb(20, 14, 56)" />
                </View>
                <Text style={{fontSize: 18, color: 'white', paddingLeft: 15}}>
                  Sửa thông tin
                </Text>
...
export default CustomerSpecified;
